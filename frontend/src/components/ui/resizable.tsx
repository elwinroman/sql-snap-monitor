...
// }
const ResizablePanel = React.forwardRef<ResizablePrimitive.ImperativePanelHandle, React.ComponentProps<typeof ResizablePrimitive.Panel>>(
...
function ResizableHandle({
  ...
  return (
    ...
    >
      {withHandle && (
        <div className="z-10 flex items-center justify-center rounded-xs">
          <GripVertical size={12} color="gray" />
        </div>
      )}
    </ResizablePrimitive.PanelResizeHandle>
  )
