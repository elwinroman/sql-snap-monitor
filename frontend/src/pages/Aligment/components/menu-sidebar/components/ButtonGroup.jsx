...
export function ButtonGroup() {
  ...
  return (
    <section className="flex w-full gap-2">
      <Button variant="secondary" size="default" className="w-full" onClick={handleClickConsultar}>
        Consultar
      </Button>

      <Button variant="secondary" size="default" className="w-full" onClick={handleClickLimpiar}>
        Limpiar
      </Button>
    </section>
  )
